...
if selected_segment == "All Segments":
    ...
    selected_profiles = int(selected["customer_profiles"])

    selected_sales_share = selected["sales_share"]

    selected_profit_margin = selected["profit_margin"]

    selected_avg_orders = selected["avg_orders"]

    selected_avg_discount = selected["avg_discount"]
...
st.markdown(
 ...
 # 14. DISCOUNT VS PROFITABILITY
    #i added an explanation of this section
    ...
    st.markdown(
        ...
        <div style="color: #888; font-size: 0.9rem; margin-bottom: 10px;">
            ...
            Does higher discounting appear to be associated with lower profitability
    ...
    discount_profit = (
    customer_summary.groupby("segment_name")
    .agg(
        avg_discount=("avg_discount", "mean"),
